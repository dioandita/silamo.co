...
<div class="col-md-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      ...
      <form class="login-form" method="POST" action="{{ route('datauser.update',$data->id) }}">
            {{csrf_field()}}
            {{ method_field('PATCH') }}
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nohp" name="nohp" placeholder="No Handphone" value="{{ $data->nohp}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="form-control form-control-lg" id="isAdmin" name="isAdmin" value="{{ $data->isAdmin}}">
